...
const GpsIcon = () => (
  ...
  >
    <path
      d="M10.5 2C7.45929 2 5 4.817 5 8.3C5 13.025 10.5 20 10.5 20C10.5 20 16 13.025 16 8.3C16 4.817 13.5407 2 10.5 2ZM10.5 10.55C9.41571 10.55 8.53571 9.542 8.53571 8.3C8.53571 7.058 9.41571 6.05 10.5 6.05C11.5843 6.05 12.4643 7.058 12.4643 8.3C12.4643 9.542 11.5843 10.55 10.5 10.55Z"
      fill="white"
    />
  </svg>
);
...
const Point = (props) => {
  return (
    <div
      class={`${
        props.state ? "bg-green-400" : "bg-green-900"
      } ease-in duration-500 w-2 h-2 rounded-full border border-solid border-gray-900`}
    ></div>
  );
};
      ...
      <Show keyed when={!settings().Voice}>
        <div className="flex gap-2 items-center">
          ...
          <div class="flex flex-col gap-1 -rotate-180">
            <For each={currentMicRangeStatus()}>
              {(range, i) => <Point state={range} />}
            </For>
          </div>
        </div>
      </Show>
