...
const AmmoIcon = () => (
  ...
  >
    <g clip-path="url(#clip0_22_190)">
      <path
        d="M11.3153 9.39321V4.30164C11.3153 4.20778 11.2496 4.13193 11.1682 4.13193H8.52062C8.43927 4.13193 8.37354 4.2078 8.37354 4.30164V9.39321C8.37354 9.48708 8.43929 9.56292 8.52062 9.56292V9.73263C8.43927 9.73263 8.37354 9.8085 8.37354 9.90234V10.5812C8.37354 10.6751 8.43929 10.7509 8.52062 10.7509H11.1682C11.2496 10.7509 11.3153 10.6751 11.3153 10.5812V9.90238C11.3153 9.80852 11.2496 9.73267 11.1682 9.73267V9.56296C11.2496 9.56294 11.3153 9.48708 11.3153 9.39321Z"
        fill="white"
      />
      <path
        d="M8.66761 3.79267H11.021C11.1024 3.79267 11.1681 3.7168 11.1681 3.62296V3.45325C11.1681 2.33753 10.7061 1.27169 9.93257 0.601963C9.88021 0.556649 9.80843 0.556649 9.75607 0.601963C8.98252 1.27169 8.52051 2.33751 8.52051 3.45325V3.62296C8.52053 3.7168 8.58626 3.79267 8.66761 3.79267Z"
        fill="white"
      />
    </g>
    <g clip-path="url(#clip1_22_190)">
      <path
        d="M5.88441 9.39321V4.30164C5.88441 4.20778 5.81866 4.13193 5.73733 4.13193H3.08971C3.00836 4.13193 2.94263 4.2078 2.94263 4.30164V9.39321C2.94263 9.48708 3.00838 9.56292 3.08971 9.56292V9.73263C3.00836 9.73263 2.94263 9.8085 2.94263 9.90234V10.5812C2.94263 10.6751 3.00838 10.7509 3.08971 10.7509H5.73733C5.81868 10.7509 5.88441 10.6751 5.88441 10.5812V9.90238C5.88441 9.80852 5.81866 9.73267 5.73733 9.73267V9.56296C5.81866 9.56294 5.88441 9.48708 5.88441 9.39321Z"
        fill="white"
      />
      <path
        d="M3.2367 3.79267H5.59014C5.67148 3.79267 5.73722 3.7168 5.73722 3.62296V3.45325C5.73722 2.33753 5.27521 1.27169 4.50166 0.601963C4.4493 0.556649 4.37752 0.556649 4.32516 0.601963C3.55161 1.27169 3.0896 2.33751 3.0896 3.45325V3.62296C3.08962 3.7168 3.15535 3.79267 3.2367 3.79267Z"
        fill="white"
      />
    </g>
    <defs>
      <clipPath id="clip0_22_190">
        <rect
          ...
          height="10.1832"
          fill="white"
          transform="translate(5.43115 0.567383)"
        />
      </clipPath>
  ...
  return (
    <Show keyed when={!props?.hide}>
      <div className="flex gap-2 mb-4">
        ...
        <div className="ml-4">
          {props?.serverLogo ? (
            <img class="w-5/12" alt="no picture" src={props?.serverLogo} />
          ) : (
            <Logo />
          )}
        </div>
  ...
  return (
    <div className="flex flex-col gap-2 w-48 absolute right-0 top-6">
      <FirstRow
        ...
        onlinePlayers={hud().onlinePlayers}
        serverLogo={serverLogo()}
      />
      <SecondRow
        hide={settings().Money}
        bank={hudStorageState.hud.moneys.bank}
        money={moneys().money}
        jobLabel={job()}
      />
      <ThirdRow
        hide={settings().Weapon}
        use={hud().weaponData?.use}
        name={weapon().name}
        image={weapon().image}
        currentAmmo={weapon().currentAmmo}
        isWeaponMelee={weapon().isWeaponMelee}
