...
/*SVGS*/
const VehicleSpeedIndicator = (props) => (
  <svg
    style="position: absolute;top: 50%;left: 50%;transform: translate(-58%, -65%);"
...
const VehicleDamageIndicator = (props) => (
  <svg
    style="position: absolute;top: 50%;left: 50%;transform: translate(-64%, -66%) rotate(0deg);"
    className="absolute left-0"
    width="365"
    height="450"
    viewBox="0 0 310 280"
...
const ArrowsIcon = (props) => {
  ...
  return (
    <div class="mt-4 flex gap-4 items-center justify-center">
      ...
      <div>
        <p class="textColor unitTextColor">{props?.kmh ? "km/h" : "mph"}</p>
      </div>
      <div>
    ...
    <defs>
      <clipPath id="clip0_22_147">
        <rect
          ...
          width="21"
          height="21"
          transform="translate(0.0869141 0.862)"
        />
      </clipPath>
    </defs>
  </svg>
...
const TempomatIcon = (props) => (
  <svg
    class="absolute bottom-[21px] left-[111px]"
    width="24"
    height="24"
    viewBox="0 0 24 24"
    fill="none"
  ...
  >
    <path
      class="tempomatIcon"
      d="M20.39 8.56001L19.15 10.42C19.7432 11.6031 20.0336 12.9148 19.9952 14.2377C19.9568 15.5606 19.5908 16.8533 18.93 18H5.06999C4.21115 16.5101 3.85528 14.7831 4.05513 13.0751C4.25497 11.367 4.9999 9.76884 6.17946 8.51744C7.35903 7.26604 8.91045 6.42805 10.6037 6.12771C12.297 5.82736 14.042 6.08064 15.58 6.85001L17.44 5.61001C15.4695 4.33293 13.1125 3.78997 10.7819 4.07628C8.45132 4.36259 6.2958 5.45991 4.69304 7.17595C3.09028 8.892 2.14252 11.1173 2.0158 13.462C1.88909 15.8067 2.59151 18.1212 3.99999 20H20C21.2266 18.3613 21.9207 16.3856 21.9887 14.3398C22.0566 12.2939 21.4951 10.2765 20.38 8.56001H20.39Z"
      fill-opacity={props?.state ? "1" : "0.5"}
    />
    <path
      class="tempomatIcon"
      d="M10.59 15.41C10.7757 15.5959 10.9963 15.7435 11.2391 15.8441C11.4819 15.9448 11.7422 15.9966 12.005 15.9966C12.2678 15.9966 12.5281 15.9448 12.7709 15.8441C13.0137 15.7435 13.2342 15.5959 13.42 15.41L19.08 6.91998L10.59 12.58C10.404 12.7657 10.2565 12.9863 10.1559 13.2291C10.0552 13.4719 10.0034 13.7322 10.0034 13.995C10.0034 14.2578 10.0552 14.5181 10.1559 14.7609C10.2565 15.0037 10.404 15.2242 10.59 15.41Z"
      fill-opacity={props?.state ? "1" : "0.5"}
    />
  </svg>
);
const DoorIcon = (props) => (
  <svg
    class="absolute right-[73px] bottom-[37px]"
    width="25"
    height="25"
    viewBox="0 0 25 25"
    fill="none"
  ...
  >
    <path
      class="doorIcon"
      d="M19.0869 14.862H16.0869V16.862H19.0869V14.862ZM22.0869 21.862H3.08691V11.862L11.0869 3.862H21.0869C21.3521 3.862 21.6065 3.96736 21.794 4.15489C21.9816 4.34243 22.0869 4.59678 22.0869 4.862V21.862ZM11.9169 5.862L5.91691 11.862H20.0869V5.862H11.9169Z"
      fill-opacity={props?.state ? "1" : "0.5"}
    />
  </svg>
);
const LightIcon = (props) => (
  <svg
    class={`absolute ${
      props?.vehType
        ? "right-[111px] bottom-[21px]"
        : "right-[138px] bottom-[22px]"
    }`}
    width="25"
    height="25"
    viewBox="0 0 25 25"
...
const EngineIcon = (props) => (
  <svg
    class="absolute left-[67px] bottom-[34px]"
    width="25"
    height="25"
    viewBox="0 0 25 25"
    fill="none"
  ...
  >
    <path
      class="engineIcon"
      d="M7.08691 4.862V6.862H10.0869V8.862H7.08691L5.08691 10.862V13.862H3.08691V10.862H1.08691V18.862H3.08691V15.862H5.08691V18.862H8.08691L10.0869 20.862H18.0869V16.862H20.0869V19.862H23.0869V9.862H20.0869V12.862H18.0869V8.862H12.0869V6.862H15.0869V4.862H7.08691Z"
      fill-opacity={props?.state ? "1" : "0.5"}
    />
  </svg>
);
...
export const Speedo = (props) => {
      ...
      if (i % defaultObject.noOfSmallDiv === 0) {
        ...
        rows.push(
          <>
            <div
              class={`nob ${dangCls}`}
              style={`left: ${induCatorLinesPosTop}px; top: ${induCatorLinesPosLeft}px; ${tempDegInd}`}
            ></div>
            <div
              class={`numb ${dangCls}`}
  ...
  createEffect(() => {
    ...
    const elementsTemplate = document.querySelectorAll(
      "#templateSpeedoContainer .nob"
    );
    const currentSpeed = VehType.AIR !== vehType() ? speed() : rpm();

    if (settings().Needle) {
      const speedNoble = document.querySelectorAll(
        "#speedoContainer .speedNobe"
      );
      if (speedNoble.length > 0) {
        const speedInDeg =
          (266 / defaultObject.maxVal) * currentSpeed + defaultObject.initDeg;
  ...
  const VehicleHud = () => {
    return (
      <>
        ...
        <LightIcon
          state={indicators()?.light}
          vehType={vehType() !== VehType.AIR}
        />
        ...
        <Show when={!settings().Needle} keyed>
          <h2 class="text-5xl z-20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 textColor currentSpeedTextColor">
            {speed()}
          </h2>
        </Show>
          ...
          <div class="flex flex-col">
            ...
            <div>
              <Show when={props?.template || isDriver()} keyed>
                <span class="textColor mileageTextColor">
                  {mileage()}
                  {isKmh() ? "km" : "mi"}
                </span>
              </Show>
            ...
            <div class="flex flex-col items-center justify-center">
              <div class="textColor fuelTextColor">
                {fuel().level}/{fuel().maxLevel}
              </div>
              <div>
                <FuelIcon />
              </div>
  ...
  const AirHud = () => {
    return (
      <>
        ...
        />
        <EngineIcon state={indicators()?.engine} />
        <h2 class="text-5xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[70%] textColor currentSpeedTextColor">
          {speed()}
        </h2>
        <div class="absolute w-[30%] top-1/2 left-1/2 -translate-x-1/2 translate-y-[15%]">
          <div class="flex flex-col">
  ...
  return (
    <div
      class={`${
        props?.template ? "template-main-container" : "speedo main-container"
      } ${!show() && !props?.template ? "slideOut" : ""}`}
    >
      ...
      <div
        ...
        id={props?.template ? "templateSpeedoContainer" : "speedoContainer"}
      >
        {createTemplate()}
      </div>
    </div>
